      ...
      <div className="bg-gray-100 text-gray-800 py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-start">
            ...
            <div className="p-5">
              <Link href="/" className="-m-1 p-1.5 inline-block">
                <svg
                  id="Layer_1"
                  className="h-10 md:h-12" //Ajusta la altura del logo
                  data-name="Layer 1"
              ...
              <p className="text-sm mb-2 text-justify">
                Puedes contactarte con nosotros en este horario sin embargo a
                cualquier hora y día puedes enviar tus solicitudes.
              </p>
              <br />
              <strong className="font-semibold">Horario de Atención</strong>
              <p className="text-sm">Lunes - Viernes, 8:00 a.m. - 6:00 p.m.</p>
            </div>
            {/* ********************************************* */}
            {/* Columna 2: Navegación */}
            <div className="p-5 flex flex-col justify-center items-center">
              {/*Centrado vertical */}
              <div className="uppercase text-red-600 font-bold mb-2 sm:mb-4 text-center">
                Navegación
              </div>
              <nav className="text-sm flex flex-col items-center">
                <Link
                  className="block py-1 text-center md:text-center hover:text-red-600"
                  href="/#"
                >
                  Inicio
                </Link>
            ...
            <div className="p-5">
              ...
              <div className="flex flex-row md:flex-col space-x-4 md:space-x-0 space-y-0 md:space-y-2 items-center md:items-center justify-center">
                <Link
                  href="https://www.instagram.com/yokohamatire/?hl=en"
                  target="_blank"
                  className="bg-gray-900 text-white rounded-full p-2 shadow-lg hover:bg-red-600 hover:scale-105 transition-all w-10 h-10 flex items-center justify-center"
                >
            ...
            {/* ********************************************* */}
            {/* Columna 4: Logo Cauchos La Mundial */}
            <div className="p-5 flex justify-center md:justify-start lg:justify-end items-center">
              <Link
                href="https://cauchoslamundial.com.ve/#/"
                target="_blank"
                className="-m-1 p-1.5 inline-block"
              >
                <img
                  src="/clm.png"
                  className="h-24 md:h-32 object-contain md:my-12 lg:my-12"
                  alt="Logo-CLM"
                />
                {/*Aumento de alutra */}
              </Link>
        ...
        <div className="bg-gray-100 pt-2">
          <div className="mt-6 py-3 text-center items-center text-xs text-gray-500 border-t border-gray-300">
            {/* ***************************************************** */}
            {/* Copyright */}
            <div className="my-3">
              © Yokohama Venezuela. Todos los Derechos Reservados GLM.
            </div>
            {/* ********************************************* */}
          </div>
        </div>

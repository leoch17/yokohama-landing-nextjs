  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <div className="bg-[url('/products/geolandar_x-mt/background-x-mt.webp')] bg-cover bg-center text-white py-10 md:py-20">
                ...
                >
                  <SwiperSlide className="cursor-pointer">
                    <div className="container pt-8 pb-6 md:pt-20 md:pb-10 sm:pt-16 sm:pb-8">
                      ...
                      <div className="relative w-full h-full flex justify-center items-center">
                        <Image
                          src="/products/geolandar_x-mt/tire-3-x-mt.webp"
                  ...
                  <SwiperSlide className="cursor-pointer px-20">
                    <div className="container pt-8 pb-6 md:pt-20 md:pb-10 sm:pt-16 sm:pb-8">
                      ...
                      <div className="relative w-full h-full flex justify-center items-center">
                        <Image
                          src="/products/geolandar_x-mt/tire-2-x-mt.webp"
                          alt="Neumatico Geolandar X-MT"
                          width={600}
                          height={600}
                          className="w-64 h-64 object-contain"
                        />
                  ...
                  <SwiperSlide className="cursor-pointer px-20">
                    <div className="container pt-8 pb-6 md:pt-20 md:pb-10 sm:pt-16 sm:pb-8">
                      ...
                      <div className="relative w-full h-full flex justify-center items-center">
                        <Image
                          src="/products/geolandar_x-mt/tire-1-x-mt.webp"
                          alt="Neumatico Geolandar X-MT"
                          width={600}
                          height={600}
                          className="w-64 h-64 object-contain"
            ...
            <div className="md:w-1/2 text-center md:text-left relative z-0">
              ...
              <div className="mb-4">
                <div className="grid grid-cols-2">
                  <Image
                    src="/products/geolandar_x-mt/logo-x-mt.png"
                    alt="Titulo Geolandar X-MT"
                    width={150}
                    height={150}
                  />
                  <div className="grid grid-cols-7">
                    <div className="">
                      <Image
                        src="/products/geolandar_x-mt/icon-1-x-mt.svg"
                        alt="Icono 1 Geolandar X-MT"
                        width={30}
                        height={30}
                      />
                    </div>
                    <div className="">
                      <Image
                        src="/products/geolandar_x-mt/icon-2-x-mt.svg"
                        alt="Icono 2 Geolandar X-MT"
                        width={30}
                        height={30}
                      />
                    </div>
                    <div className="">
                      <Image
                        src="/products/geolandar_x-mt/icon-3-x-mt.svg"
                        alt="Icono 3 Geolandar X-MT"
                        width={30}
                        height={30}
                      />
                    </div>
                    <div className="">
                      <Image
                        src="/products/geolandar_x-mt/icon-4-x-mt.svg"
                        alt="Icono 4 Geolandar X-MT"
                        width={30}
                        height={30}
                      />
                    </div>
                    <div className="">
                      <Image
                        src="/products/geolandar_x-mt/icon-5-x-mt.svg"
                        alt="Icono 5 Geolandar X-MT"
                        width={30}
                        height={30}
                      />
                    </div>
                    <div className="">
                      <Image
                        src="/products/geolandar_x-mt/icon-6-x-mt.webp"
                        alt="Icono 6 Geolandar X-MT"
                        width={30}
                        height={30}
                      />
                    </div>
              ...
              <p className="text-gray-300 mb-8">
                Diseñado para los rockeros de hoy en día, el GEOLANDAR X-MT®
                demanda respeto en cualquier camino. Construido con tecnología
                GEO-SHIELD®, esta orgullosa incorporación a la gama GEOLANDAR
                ofrece un agarre todoterreno impecable, despiadado rendimiento y
                la fuerza para llevarte a la cima - y mantenerte allí.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative">
        ...
        <div className="bg-[url('/products/geolandar_x-mt/background-2-x-mt.webp')] bg-cover bg-center text-white py-10 md:py-20 relative z-0">
          ...
          <div className="relative z-0 text-white py-10 md:py-12">
            <div className="container mx-auto px-4 md:px-8 lg:px-16">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">
                GEOLANDAR X-MT® TAMAÑO & ESPECIFICACIONES
              </h2>

              {/* Showing Specs For */}
              <h3 className="text-lg font-semibold mb-8 text-center">
                Mostrando especificaciones para 35X12.50R17 121Q
              </h3>
                ...
                <div className="md:order-1">
                  <div className="grid grid-cols-2 gap-y-4 gap-x-6 mb-8">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">110155501</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold">34.8</p>
                    </div>
                    {/* Load I.D. */}
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold">8.5 - 11.0</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold">3195 @ 65</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold">13.0</p>
                    </div>
                    {/* Type */}
                    <div>
